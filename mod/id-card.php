                ...
                <div class="text-center">
                    ...
                    <div class="id-card">
                        <div class="body-id-card text-center" id="divToPrint">
                            <div class="avatar">
                                    <img src="../content/karyawan/2021-06-2618e2999891374a475d0687ca9f989d83.jpg" alt="Badrul Juki" class="imaged w100 rounded">
                            </div>
                            <h3>Badrul Juki</h3>
                            <p>badruljuki</p>
                            <div class="barcode">
                                <img class="img-responsive text-center" src="../content/employees-code-qr/badruljuki.jpg" alt="QR CODE">
                            </div>
                            <p>badruljuki</p>
                        </div>
                    </div>                    <hr>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.1/html2canvas.js"></script><script type="text/javascript">
    /* ---------- Save Id Card ----------*/
